      ...
      <div className="flex flex-row  gap-6 ml-8">
        <div className="flex-col mt-14 flex flex-auto w-64 gap-6">
          <h3 className="text-3xl font-medium" data-aos={"fade-left"}>
            I'm <span className="text-yellow-600">Yaseen Levy,</span> a Fullstack Web
            Developer
          </h3>
          <p
          ...
          >
            ...
            I am {getDate()}{" "} years old. I enjoy going to the gym, coding and love learning new technologies. I am
            currently pursuing an Advanced Diploma in Applications Development. 
          </p>
          <p
            className="text-justify leading-7 text-slate-900"
            data-aos={"fade-right"}
          >
            I am currently a BI Developer. Currently seeking new oppurtunities to grow.
            My tech stack includes a wide variety of technologies I have worked with before.
          </p>
        </div>
